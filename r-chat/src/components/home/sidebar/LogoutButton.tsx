...
function LogoutButton({ setError, setErrorMessage }: { setError: Function, setErrorMessage: Function }) {
    ...
    return (
        <div data-testid='logout-btn' onClick={(e) => handleLogout(e)} className='w-full text-white min-h-[3rem] cursor-pointer flex items-center transition-all ease-in-out 150 hover:text-primary'>
